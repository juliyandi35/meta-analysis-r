...
dir.create("Significance Tables SMD", showWarnings = FALSE)
...
run_analysis <- function(file_path) {
  ...
  write.xlsx(
    result_table,
    file = paste0("Significance Tables SMD/", outcome, " summary_effect.xlsx"),
    overwrite = TRUE
  )
  ...
  funnel(
    meta_result,
    main = paste("Funnel Plot -", outcome),
    pch = 16,     # bentuk titik solid
    cex = 2       # memperbesar ukuran titik
  )
